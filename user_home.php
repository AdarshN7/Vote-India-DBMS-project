...
<head>
    <title>Users Home - VoterId</title>
    ...
    <div id="banner_image">
                ...
                <div class="login100-form validate-form">
                    ...
                    <div class="container-login10-form-btn">
                        <div class="wrap-login10-form-btn">
                            ...
                            <a href="vote_application.php" class="login10-form-btn" type="button" target="_self">
                                Apply
                            </a>
                        </div>
                        <div class="wrap-login10-form-btn">
        ...
        <div class="modal fade" id="loginModalCenter2" tabindex="-1" role="dialog" aria-labelledby="loginModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="loginModalLongTitle">Status</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
