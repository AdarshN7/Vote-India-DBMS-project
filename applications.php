...
<head>
    <title>Applications - VoterId</title>
...
<body>
    ...
    <div id="banner_image">
        ...
        ?>
        <center>
            <div class="wrap-login100 " style="padding: 50px 50px; width: 90%;">
                <?php
                            ...
                            <tbody>
                                ...
                                <?php while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td><a href="approve.php?id=<?php echo $row["id"]; ?>" class="btn btn-success">Approve</a></td>
                                    </tr>
                                <?php
                                }
                                ?>
